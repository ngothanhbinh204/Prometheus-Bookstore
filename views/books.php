...
//     $current_page1 = 1;
// };
// $rows = $conn->query("SELECT COUNT(*) FROM books")->fetchColumn();
// $totalPages1 = ceil($rows / 2);

// if ($current_page1 > 3) {
//     $first_page = 1;
//     echo "<a class='page_link' href='index.php?pgs=books&page=$first_page'>First</a>";
// }

// if ($current_page1 > 1) {
//     $prev_page = $current_page1 - 1;
//     echo "<a class='page_link' href='index.php?pgs=books&page=$prev_page'>Prev</a>";
// }
...
//     $prev_page = $current_page1 + 1;
//     echo "<a class='page_link' href='index.php?pgs=books&page=$prev_page'>Next</a>";
// }

// if ($current_page1 < $totalPages1 - 3) {
//     $prev_page = $totalPages1;
//     echo "<a class='page_link' href='index.php?pgs=books&page=$totalPages1'>Last</a>";
// }
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    ...
                    if (isset($_GET['categ_id'])) {
                        ...
                        if ($total_pages > 1) {
                            $button_last = '<a class="page-link" href="index.php?pgs=books&categ_id=' . $categ_id . '&page=' . ($total_pages) . '"><i class="fa fa-angle-right"></i></a>';
                        }

                        if ($page < $total_pages && $total_pages > 1) {
                            $button_next = '<a class="page-link" href="index.php?pgs=books&categ_id=' . $categ_id . '&page=' . ($page + 1) . '"><i class="fa fa-angle-right"></i></a>';
                        }

                        if ($page > 1 && $total_pages > 1) {
                            $button_prev = '<a class="page-link" href="index.php?pgs=books&categ_id=' . $categ_id . '&page=' . ($page - 1) . '"><i class="fa fa-angle-left"></i></a>';
                        }
