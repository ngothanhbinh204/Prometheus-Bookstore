            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    ...
                    if (isset($_GET['categ_id'])) {
                        ...
                        if ($page > 1) {
                            $button_last = '<a class="page-link" href="index.php?pgs=audioBooks&categ_id=' . $categ_id . '&page=' . ($total_pages) . '"><i class="fa fa-angle-right"></i></a>';
                        }

                        if ($page < $total_pages && $total_pages > 1) {
                            $button_next = '<a class="page-link" href="index.php?pgs=audioBooks&categ_id=' . $categ_id . '&page=' . ($page + 1) . '"><i class="fa fa-angle-right"></i></a>';
                        }

                        if ($page > 1 && $total_pages > 1) {
                            $button_prev = '<a class="page-link" href="index.php?pgs=audioBooks&categ_id=' . $categ_id . '&page=' . ($page - 1) . '"><i class="fa fa-angle-left"></i></a>';
                        }
                                ...
                                for ($i = 1; $i <= $totalPages1; $i++) {
                                    if ($current_page1 != $i) {
                                        if ($i > $current_page1 - 3 && $i < $current_page1 + 3) {
                                            echo  "<a class='page_link' href='index.php?pgs=audioBooks&page=$i'>$i</a>";
                                        }
                                    } else {
                                        echo  "<a class='page_link page_strong' href='index.php?pgs=audioBooks&page=$i'>$i</a>";
                                    }
                                }
                                echo '
                            ' . $button_next_audioBook . '
