...
$list_new_book = get_new_books(4);

$list_books_promotional = get_books_promotional(4);

$list_books_besteller = get_books_besteller(4);

$html_random_book = get_books_random(4);
    ...
    switch ($pgs) {
        ...
        case 'order':
            if (!isset($_SESSION["user"])) {
                $error = "Vui Lòng Đăng Nhập Tài Khoản Để Thanh Toán ";
                include "views/checkout.php";
            } else {
        ...
        case 'blog':
            // lấy 1 sách đầu tiên
            $list_blog1 = get_blog(0, 1);
            // lấy 2 sách từ sách 1
            $list_blog2 = get_blog(1, 2);
            $list_blog3 = get_blog(3, 4);
            $list_blog4 = get_blog(7, 2);
            $list_blog5 = get_blog(9, 1);
