...
function get_books_random($number)
{
    ...
    INNER JOIN book_images 
        ...
        WHERE book_images.images like '%_1.jpg' and  books.fm_id = 1
    ORDER BY RAND()
    LIMIT " . $number;
...
{
    $sql = "SELECT books.id as id, books.title as title, books.price as price, authors.au_name as author, books.sale_off as sale_off ,  ROUND((books.price * books.sale_off/100), 3) as GiaGiam
    FROM books 
    INNER JOIN authors ON authors.id = books.au_id
...
function get_books_besteller($number)
{
    $sql = "SELECT  books.id as id, books.title as title, books.price as price, authors.au_name as author, COUNT(orders.book_id) as bestseller
    FROM orders
...
{
    $sql = "SELECT books.id as id ,books.title as title, books.price as price, books.views as views, books.book_description as descript, authors.au_name as author, formats.fm_name as format, books.soluong as soluong , ROUND((books.price * books.sale_off/100), 3) as GiaGiam
    FROM books 
    INNER JOIN authors 
    ON authors.id = books.au_id
    INNER JOIN formats 
...
function show_books_random($books_list)
{
    $html_books_list = '';
        ...
        $html_books_list .= '<div class="col-lg-3 col-md-6">
                                    <div class="product__item ">
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <div class="product__price">' . $price . 'đ<span></span></div>
...
function show_books_promotional($books_list)
{
    $html_books_list = '';
    foreach ($books_list as $book) {
        extract($book);
        ...
        $html_books_list .= '<div class="col-lg-3 col-md-6">
                                    <div class="product__item sale">
                                        <div class="product__item__pic set-bg" data-setbg="./publics/img/product/books/book_' . $id . '_1.jpg">
                                        <div class="label sale">Sale ' . $sale_off . ' %</div>
                                                ...
                                                <ul class="product__hover">
                                                    ...
                                                    <li>
                                                    <input id="quantity' . $id . '" type="hidden" name="quantity" value="1">
                                                    <input id="price' . $id . '" type="hidden" name="price" value="' . $GiaGiam . '">
                                                    <input id="name' . $id . '" type="hidden" name="title" value="' . $title . '">
                                                    <input id="quantity' . $id . '" type="hidden" name="quantity" value="1">
                                                    <button id="' . $id . '" type="submit" name="add_to_cart" class="add_to_cart" value="Add to Cart"><span class="icon_bag_alt add_to_cart"></span></button></li>
                                                    </form>
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <div class="product__price">' . $GiaGiam . 'đ<span>' . $price . '</span></div>
