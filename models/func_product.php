<?php
function insert_product($title, $isbn_13, $price, $book_description, $fm_id, $au_id, $pub_id, $creation_date)
{
    $sql = "INSERT INTO books (title, isbn_13, price, book_description,fm_id, au_id, pub_id, creation_date) VALUES('$title','$isbn_13', '$price', '$book_description', '$fm_id', '$au_id', '$pub_id', '$creation_date')";
...
{
    $sql = "SELECT COUNT(`id`) as total_books FROM `books` WHERE 1;";
    $books = pdo_query_one($sql);
    return $books;
}
